...
新增 `scripts/seed-tickets.js` 脚本，用于填充完整的车票测试数据。

**数据内容：**
- 40 条完整车票记录
- 覆盖多个城市：北京、上海、广州、成都、武汉、南京、杭州、西安、合肥、沈阳、重庆、哈尔滨等
- 每个记录包含完整字段：电子客票号、车次、出发/到达站点、日期、时间、价格、座位类型、座位号、售票地点、检票口、备注、主题颜色、里程等
